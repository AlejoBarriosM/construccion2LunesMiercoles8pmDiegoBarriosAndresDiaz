...
function Partners() {
    ...
    const loadPartners = useCallback(async () => {
        try {
            const response = await request('get', '/partnersAPI/v1/partner')
    ...
    if (apiError) {
        return <div className="flex justify-center items-center h-screen">Error al cargar los socios. Por favor, intente de nuevo más tarde.</div>
    }
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>
                                    <Button variant="ghost" onClick={() => toggleSort('typePartner')}>
                                        Tipo {renderSortIcon('typePartner')}
                                    </Button>
                                </TableHead>
                                <TableHead>
                        ...
                        <TableBody>
                            {sortedPartners.map((partner) => (
                                <TableRow key={partner.idPartner}>
                                    ...
                                    <TableCell>{partner.typePartner}</TableCell>
